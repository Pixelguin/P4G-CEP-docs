...
> If you are using **P3F CEP** and already have an `Aemulus` folder, Windows will ask you to merge the two folders. Select **Yes**. You will need to set up your file paths again, but nothing else will be changed.
